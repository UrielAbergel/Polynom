...
class PolynomTest {
    ...
    void add() {
        ...
        a.add(a2);
        a.add(a3);
        Assertions.assertEquals("3.0x^4+3.0x^3+3.0x^2+3.0x^1+13.0x^0+",a.returnPolynomToString());
    }
    ...
    void testAddMonom() {
        ...
        a.add(m3);
        a.add(m4);
        Assertions.assertEquals("1.0x^100+1.0x^4+1.0x^3+-14.0x^2+6.0x^1+6.0x^0+",a.returnPolynomToString());
    }
    ...
    void substract() {
        ...
        Assertions.assertEquals("-5.0x^6+16.0x^2+7.0x^1+-6.0x^0+",test1.returnPolynomToString());
    }
    ...
    void multiply() {
        ...
        Assertions.assertEquals("0.0x^0+",test1.returnPolynomToString());
        Assertions.assertEquals("-7.0x^2+",test2.returnPolynomToString());
        Assertions.assertEquals("15.0x^8+-24.0x^4+",test3.returnPolynomToString());
    ...
    void testEquals() {
        ...
        Assertions.assertEquals(test1,test11);
        Assertions.assertEquals(test2,test22);
        Assertions.assertEquals(test3,test33);
        ...
        Assertions.assertNotEquals(test4,test44);
        Assertions.assertEquals(test5,test55);
        Assertions.assertEquals(test6,test66);
    }
    ...
    void copy() {
        ...
        p.substract(w);
        Assertions.assertEquals(t.iteretor().next().get_coefficient(),5);
    }
    ...
    void derivative() {
        ...
        Assertions.assertEquals(test1.equals(test11),true);
        Assertions.assertEquals(test2.equals(test22),true);
        Assertions.assertEquals(test3.equals(test33),true);
